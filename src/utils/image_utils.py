...
def main(image_path: str, out_path: str, target_resolution: tuple[int, int], bottom_y: float | int = 1., top_left: tuple[int, int] = (0, 0), crop_by_target_size: bool = False) -> None:
